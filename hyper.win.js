...
module.exports = {
  config: {
    ...
    cursorColor: 'rgba(0,149,225,0.8)',
    ...
    //
    // Windows WSL:
    // https://docs.microsoft.com/ja-jp/windows/wsl/reference#arguments-for-running-linux-commands
    shellArgs: ['~'],
    ...
    paneNavigation: {
      ...
      hotkeys: {
        ...
        jump_prefix: 'alt+ctrl', // completed with 1-9 digits
      },
      showIndicators: true, // Show pane number
      indicatorPrefix: 'alt+ctrl+', // Will be completed with pane number
  ...
  keymaps: {
    ...
    //"pane:next": "command+ctrl+l",
    //"pane:prev": "command+ctrl+h",
    "pane:splitVertical": [
      "command+ctrl+s",
      "alt+ctrl+s",
    ],
